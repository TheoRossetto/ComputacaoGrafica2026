...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "M4 - Iluminacao de Phong", nullptr, nullptr);
...
void updateWindowTitle(GLFWwindow* window)
{
    ...
    string title = "M4 | Objeto: " + objects[activeObj].name
        ...
        if (mtlIn.is_open())
        {
            ...
            while (getline(mtlIn, mtlLine))
            {
                ...
                if (mtlWord == "map_Kd")
                {
                    ...
                    mtlss >> mat.Ka.r >> mat.Ka.g >> mat.Ka.b;
                else if (mtlWord == "Kd")
                    mtlss >> mat.Kd.r >> mat.Kd.g >> mat.Kd.b;
                else if (mtlWord == "Ks")
                    mtlss >> mat.Ks.r >> mat.Ks.g >> mat.Ks.b;
                else if (mtlWord == "Ns")
                    mtlss >> mat.Ns;
            }
            mtlIn.close();
